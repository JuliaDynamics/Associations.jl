...
@test counts(PointEncoding(o3), x) isa Counts{<:Integer, 1}
@test counts(PointEncoding(o3), x, x) isa Counts{<:Integer, 2}

# Using multiple encodings, the number of input encodings must match the number of
# input datasets.
@test counts(PointEncoding(o3, ow), x, w) isa Counts{<:Integer, 2}
@test counts(PointEncoding(o3, o3), x, x) isa Counts{<:Integer, 2}
@test counts(PointEncoding(o2, o3), z, x) isa Counts{<:Integer, 2}
@test counts(PointEncoding(o2, o3, o3), z, x, y) isa Counts{<:Integer, 3}

# Length-2 encoding won't work on state vectors of length 3
@test_throws ArgumentError counts(PointEncoding(o2), x)
...
@test_throws ArgumentError counts(PointEncoding(o3, o2, o3), z, x, y)
