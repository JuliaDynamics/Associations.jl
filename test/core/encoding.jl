...
o = ValueBinning(3)
@test codify(CodifyVariables(o), y) isa NTuple{2, Vector{<:Integer}}
@test codify(CodifyVariables(o), (y[:, 1], y[:, 2])) isa NTuple{2, Vector{<:Integer}}
@test codify(CodifyVariables(o), (y[:, 1], y[:, 2])) ==
    codify(CodifyVariables(o), y)
