...
@test causality(x, y, twovar_constraints) isa Vector{Vector{T}} where T<:Real
@test causality(uvals_x, uvals_y, twovar_constraints) isa Vector{Vector{T}} where T<:Real
