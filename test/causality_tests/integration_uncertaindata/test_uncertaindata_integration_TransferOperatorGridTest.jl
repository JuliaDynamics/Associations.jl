...
@test causality(x, y, twovar_constraints, test_tog) isa Array{<:Real, 0}
@test causality(uvals_x, uvals_y, twovar_constraints, test_tog) isa Array{<:Real, 0}
@test causality(x, uvals_y, onevar_constraints, test_tog) isa Array{<:Real, 0}
@test causality(uvals_x, y, onevar_constraints, test_tog) isa Array{<:Real, 0}
@test causality(UVX, UVY, twovar_constraints, test_tog) isa Array{<:Real, 0}
@test causality(uvals_x, UVY, twovar_constraints, test_tog) isa Array{<:Real, 0}
@test causality(UVX, uvals_y, twovar_constraints, test_tog) isa Array{<:Real, 0}
@test causality(x, UVY, onevar_constraints, test_tog) isa Array{<:Real, 0}
@test causality(UVX, y, onevar_constraints, test_tog) isa Array{<:Real, 0}

test_tog = TransferOperatorGridTest(binning = RectangularBinning(5), ηs = -3:3) 
@test causality(x, y, twovar_constraints, test_tog) isa Array{<:Real, 1}
@test causality(uvals_x, uvals_y, twovar_constraints, test_tog) isa Array{<:Real, 1}
@test causality(x, uvals_y, onevar_constraints, test_tog) isa Array{<:Real, 1}
@test causality(uvals_x, y, onevar_constraints, test_tog) isa Array{<:Real, 1}
@test causality(UVX, UVY, twovar_constraints, test_tog) isa Array{<:Real, 1}
@test causality(uvals_x, UVY, twovar_constraints, test_tog) isa Array{<:Real, 1}
@test causality(UVX, uvals_y, twovar_constraints, test_tog) isa Array{<:Real, 1}
@test causality(x, UVY, onevar_constraints, test_tog) isa Array{<:Real, 1}
@test causality(UVX, y, onevar_constraints, test_tog) isa Array{<:Real, 1}