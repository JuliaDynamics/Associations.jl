...
@testset "Measures" begin
    @test CCM(; τ) isa ConvergentCrossMapping
    @test PairwiseAsymmetricInference(; τ) isa PairwiseAsymmetricInference
end

@testset "Basic" begin
    @test crossmap(CCM(; τ), x, y) isa Real
    @test crossmap(PAI(; τ), x, y) isa Real
