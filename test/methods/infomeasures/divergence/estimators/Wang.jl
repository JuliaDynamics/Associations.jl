...
re_wang = divergence(Shannon(), Wang(k = 5, l = 5), Dx, Dy)
re_wang_trans = divergence(Shannon(), WangTransformed(k = 5, l = 5), Dx, Dy)
...
for i = 1:nreps
    ...
    re_wang[i] = divergence(Shannon(), WangRE(k = 5, l = 5), Dx, Dy)
    re_wang_trans[i] = divergence(Shannon(), WangTransformed(k = 5, l = 5), Dx, Dy)
end
