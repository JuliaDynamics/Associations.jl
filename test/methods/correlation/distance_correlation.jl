...
@test Associations.distance_variance(a) == 0.0
...
@test Associations.ucenter(M) ≈
    [0 0.15 -0.15;
    0.15 0.0 -0.15;
    -0.15 -0.15 0.0]

@test round(association(DistanceCorrelation(), x, z, y), digits = 5) ≈ round(0.1556139, digits = 5)
@test round(Associations.distance_covariance(x, z, y), digits = 5) ≈ round(0.02379782, digits = 5)
...
@test Associations.min_inputs_vars(DistanceCorrelation()) == 2
@test Associations.max_inputs_vars(DistanceCorrelation()) == 3