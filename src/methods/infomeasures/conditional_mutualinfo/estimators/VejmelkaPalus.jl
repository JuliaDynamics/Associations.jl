...
function conditional_mutualinfo(e::Renyi, est::VejmelkaPalus, X, Y, Z)
...
conditional_mutualinfo(est::VejmelkaPalus, args...; base = 2, kwargs...) = 
    conditional_mutualinfo(Shannon(; base), est, args...; kwargs...)
