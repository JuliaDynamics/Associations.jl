...
"""
    CMI4H <: ConditionalMutualInformationDefinition
    CMI4H()
...
function estimate(def::CMI4H, measure::CMIShannon,
    est::Union{DifferentialEntropyEstimator, ProbabilitiesEstimator}, x, y, z)
    e = measure.e
    X = Dataset(x)
    Y = Dataset(y)
    Z = Dataset(z)
...
estimate(measure::CMIShannon, est::Union{ProbabilitiesEstimator, DifferentialEntropyEstimator},
