...
"""
    crossmap(x, y, d, τ; r = 0, correspondence_measure = cor) → Float64
    crossmap(x, y, d, τ, bootstrap_method::Symbol; r = 0, correspondence_measure = cor,
...
"""
function crossmap(x, y, d, τ; correspondence_measure = cor, r = 0)
    # Embed `x`
