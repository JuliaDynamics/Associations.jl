...
# input variables.
function counts(encoding::PerPointEncoding{N}, x::Vararg{ArrayOrStateSpaceSet, N}) where N
...
function counts(encoding::PerPointEncoding{1}, x::Vararg{ArrayOrStateSpaceSet, N}) where N
