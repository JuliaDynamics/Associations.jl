...
values of these constants are as defined in [1].
...
causality in a bivariate time series." Physical Review E 97.4 (2018):
042207](https://journals.aps.org/pre/abstract/10.1103/PhysRevE.97.042207)
"""
...
Initialise a 6D unidirectionally coupled Rössler-Lorenz system, where a 3D
Rössler attractor is coupled to a 3D Lorenz attractor such that the second
component  (``$x_2$``) of the Rössler system unidirectionally forces the
second component (``$y_2$``) of the Lorenz system. This example is from [1].
